    ...
    in
    {
      options.applications.firefox = {
        ...
        profilePath = lib.mkOption {
          ...
          default = "default";
          description = ''
            Directory name of the Firefox profile under the browser's config
            directory. Set this to an existing profile directory to adopt it
      ...
      config = lib.mkIf cfg.enable {
        ...
        home-manager.users.${user.name}.programs.firefox = {
          ...
          # nixpkgs' firefox stores profiles under XDG paths, but home-manager
          # keeps the legacy ~/.mozilla default below stateVersion 26.05
