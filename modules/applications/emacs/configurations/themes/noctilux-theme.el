               ...
               (let ((back base03))
                 ...
                 (let ((bg-back   `(:background ,base03))
                   ...
                   `((;; basic
                      ...
                      ;; elfeed
                      (elfeed-log-debug-level-face ((t (,@fg-base01))))
                      (elfeed-log-error-level-face ((t (,@fg-red))))
                      (elfeed-log-info-level-face ((t (,@fg-green))))
                      (elfeed-log-warn-level-face ((t (,@fg-orange))))
                      (elfeed-search-date-face ((t (,@fg-violet))))
                      (elfeed-search-feed-face ((t (,@fg-blue))))
                      (elfeed-search-filter-face ((t (,@fg-violet))))
                      (elfeed-search-last-modified-face ((t (,@fg-base01))))
                      (elfeed-search-tag-face ((t (,@fg-base01))))
                      (elfeed-search-title-face ((t (,@fg-base01))))
                      (elfeed-search-unread-count-face ((t (,@fg-yellow))))
                      (elfeed-search-unread-title-face ((t (,@fmt-bold ,@fg-base1))))
                      ;; emacs-wiki
