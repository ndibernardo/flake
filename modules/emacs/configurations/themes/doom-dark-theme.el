;;; doom-dark-theme.el --- a dark minimal theme with teal and red accents -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;;; Commentary:
;;; Code:
...
(defgroup doom-dark-theme nil
  "Options for the `dark' theme"
  :group 'doom-themes)

(defcustom doom-dark-hl-line t
  "If non-nil, highlight the current line with an underline."
  :group 'doom-dark-theme
  :type 'boolean)

(defcustom doom-dark-uniform-font-size nil
...
(def-doom-theme doom-dark
  "A dark minimal theme with teal and red accents for subtle syntax decoration."
  ...
  ((bg '("black"    "black"  "black"))
   ...
   (grey base4)
   (red       '("#cf9292" "#cc9999" "red"))
   (dark-red  '("#b22222" "#bb2222" "red"))
   (orange    '("#d4a574" "#d4a574" "brightred"))
   (green     '("#73cc98" "#73cc98" "green"))
   (teal      '("#7bd3c5" "#77ddcc" "brightgreen"))
  ...
  (((cursor &override) :background base7)
   ...
   (font-lock-function-call-face :foreground teal)
   (font-lock-preprocessor-face :foreground red)
   (font-lock-type-face :foreground base7)
   ;;;; line numbers <built-in>
   (line-number-current-line :foreground white :weight 'bold)
   ;;;; show-paren <built-in>
   (show-paren-match :foreground teal :background base3 :weight 'bold)
   ...
   (doom-modeline-evil-emacs-state :foreground teal)
   ...
   (lsp-rust-analyzer-attribute-modifier-face :foreground red)
   (lsp-face-highlight-textual :foreground bg :background highlight)
   (lsp-face-highlight-read :foreground bg :background highlight)
   (lsp-face-highlight-write :foreground bg :background highlight)
   ;;;; clojure-mode
   (clojure-keyword-face :foreground red)
   ;;;; org <built-in> <modes:org-mode>
   (org-code :foreground doc-comments)
   (org-date :inherit 'link)
   (org-date-selected :inherit 'lazy-highlight)
   (org-document-title :height (if doom-dark-uniform-font-size 1.0 1.7)
                       :foreground (if doom-dark-uniform-font-size base8 doc-comments)
   ...
   ;;;; outline
   (outline-1 :height (if doom-dark-uniform-font-size 1.0 1.5)
              :background base1 :weight 'bold)
   (outline-2 :height (if doom-dark-uniform-font-size 1.0 1.4)
              :foreground (if doom-dark-uniform-font-size (doom-darken fg 0.2))
              :background base1 :weight 'bold)
   (outline-3 :height (if doom-dark-uniform-font-size 1.0 1.3)
              :foreground (if doom-dark-uniform-font-size (doom-darken fg 0.3))
              :background base1 :weight 'bold)
   (outline-4 :height (if doom-dark-uniform-font-size 1.0 1.2)
              :foreground (if doom-dark-uniform-font-size (doom-darken fg 0.4))
              :background base1 :weight 'bold)
   (outline-5 :height (if doom-dark-uniform-font-size 1.0 1.1)
              :background base1
              :weight (if doom-dark-uniform-font-size 'normal 'bold))
   (outline-6 :height (if doom-dark-uniform-font-size 1.0 1.0)
              :foreground (if doom-dark-uniform-font-size (doom-darken fg 0.2))
              :background base1
              :weight (if doom-dark-uniform-font-size 'normal 'bold))
   (outline-7 :height (if doom-dark-uniform-font-size 1.0 1.0)
              :foreground (if doom-dark-uniform-font-size (doom-darken fg 0.3))
              :background base1 :weight 'normal)
   (outline-8 :height (if doom-dark-uniform-font-size 1.0 1.0)
              :foreground (if doom-dark-uniform-font-size (doom-darken fg 0.4))
   ...
   (treemacs-fringe-indicator-face :foreground teal)
   (treemacs-root-face :foreground fg :weight 'bold)
   (treemacs-hl-line-face :foreground teal :weight 'bold :underline nil)
   ...
   ;;;; vertico
   (vertico-current :foreground fg :background base3 :weight 'bold)
   ;;;; orderless
   (orderless-match-face-0 :foreground teal :weight 'bold)
